...
SortableVersionCovariantT = TypeVar(
    "SortableVersionCovariantT", bound="SortableVersionProtocol", covariant=True
)
...
class VersionProtocol(Protocol):
    ...
    @classmethod
    def from_flat_dict(
        cls: type[VersionT], version_dict: VersionConfig
    ) -> VersionT: ...
...
class TypedVersionProtocol(Protocol):
    ...
    @classmethod
    def _un_flatten_object(
        cls, type_: type[TypedVersionT], flat_obj: str
    ) -> TypedVersionT: ...
