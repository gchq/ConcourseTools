...
class MetadataTests(TestCase):
    ...
    def test_normal_build(self) -> None:
        ...
        self.assertEqual(
            metadata.build_url(),
            "https://ci.myconcourse.com/teams/my-team/pipelines/my-pipeline/jobs/my-job/builds/42",
        )
    ...
    def test_instanced_pipeline_build(self) -> None:
        ...
        self.assertDictEqual(
            metadata.instance_vars(), {"key1": "value1", "key2": "value2"}
        )
    ...
    def test_nested_instanced_pipeline_build(self) -> None:
        ...
        self.assertDictEqual(metadata.instance_vars(), instance_vars)
        url = (
            r"https://ci.myconcourse.com/teams/my-team/pipelines/my-pipeline/jobs/my-job/builds/42"
    ...
    def test_one_off_build(self) -> None:
        ...
        self.assertDictEqual(metadata.instance_vars(), {})
        self.assertEqual(
            metadata.build_url(), "https://ci.myconcourse.com/builds/12345678"
        )
    ...
    def test_flattening_nested_dict(self) -> None:
        nested_dict = {
            "branch": "feature-v8",
            "version": {"from": "3.0.0", "main": 2, "to": "2.0.0"},
        }
        flattened_dict = {
            "branch": "feature-v8",
            "version.from": "3.0.0",
...
class MetadataFormattingTests(TestCase):
    ...
    def test_simple_interpolation(self) -> None:
        new_string = self.metadata.format_string(
            "The build id is $BUILD_ID and the job name is $BUILD_JOB_NAME."
        )
        self.assertEqual(
            new_string, "The build id is 12345678 and the job name is my-job."
        )

    def test_interpolation_with_one_off(self) -> None:
        metadata = TestBuildMetadata(one_off_build=True)
        new_string = metadata.format_string(
            "The build id is $BUILD_ID and the job name is $BUILD_JOB_NAME."
        )
